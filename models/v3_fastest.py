...
modelConfiguration = "models/model_data/yolo-fastest-xl.cfg"
modelWeights = "models/model_weights/yolo-fastest-xl.weights"
classesFile = "models/model_data/coco.names"
